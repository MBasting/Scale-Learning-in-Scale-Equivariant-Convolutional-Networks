...
def wrn_CNN(depth=16, nr_classes=10, widen_factor = 8, drop_rate=0.3, **kwargs):
    return WideResNet(depth=depth, num_classes=nr_classes, widen_factor=widen_factor, dropRate=drop_rate)
